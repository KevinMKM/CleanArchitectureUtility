...
public class SoftwarePartDetector
{
    ...
    public async Task<SoftwarePart> Detect(string softwareName)
    {
        ...
        foreach (var controller in controllers)
        {
            if (controller.Module is null)
            {
                ...
                {
                    var service = application.Children.FirstOrDefault(c =>
                        c.Name == controller.Service && c.SoftwarePartType == SoftwarePartType.Service);
    ...
    private static SoftwarePart CreateSoftwarePartModule(string name)
        => new()
        {
            Name = name,
            SoftwarePartType = SoftwarePartType.Module,
    ...
    private static SoftwarePart CreateSoftwarePartService(string name)
        => new()
        {
            Name = name,
            SoftwarePartType = SoftwarePartType.Service,
    ...
    private static void AddControllerAndActionsToParent(SoftwarePart parent, SoftwarePartController controller)
    {
    ...
    private static void AddControllerAndActionsToCustomModuleAndCustomService(SoftwarePart application, SoftwarePartController controller)
    {
