...
public class SqlMessageInboxItemRepository : IMessageInboxItemRepository
{
    ...
    private void CreateTableIfNeeded()
    {
        try
        {
            ...
            _logger.LogInformation($"Sql Message Inbox try to create table in database with connection {_options.ConnectionString}. " +
                                   $"Schema name is {schema}. Table name is {table}");
