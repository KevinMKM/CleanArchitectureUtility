...
public class RabbitMqReceiveMessageBus : IReceiveMessageBus, IDisposable
{
    ...
    public void Subscribe(string serviceId, string eventName)
    {
        ...
        _logger.LogInformation($"ServiceId: {serviceId} With EventName: {eventName} Binded.");
    }
    ...
    public void Receive(string commandName)
    {
        ...
        _logger.LogInformation($"Command With CommandName: {commandName} Binded.");
    }
    ...
    private Activity StartChildActivity(BasicDeliverEventArgs e)
    {
        ...
        if (e.BasicProperties != null && 
            ...
            e.BasicProperties.Headers.ContainsKey("TraceId") &&
            e.BasicProperties.Headers.ContainsKey("SpanId"))
