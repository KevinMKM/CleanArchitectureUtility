...
namespace CleanArchitectureUtility.Utilities.OpenTelemetryRegistration;
...
public class MetricReporter
{
    ...
    public void RegisterRequest(string? path) => _requestCounter.Add(1, new KeyValuePair<string, object?>("path", path));
